...
#define UART_BASEADDR LPUART3_BASE
#define UART_INSTANCE 3U
...
void rt1050_init_pins(void)
{
    ...
    IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_09_GPIO1_IO09, 0U);
    IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_13_LPUART3_TXD, 0U);
    IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_14_LPUART3_RXD, 0U);
    IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B0_04_CCM_CLKO1, 0U);
    IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B0_05_CCM_CLKO2, 0U);
    IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_09_GPIO1_IO09, 0x10B0U);
    IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_13_LPUART3_TXD, 0x10B0U);
    IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_14_LPUART3_RXD, 0x10B0U);
